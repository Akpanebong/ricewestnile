        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "filled_appraisal",
                    models.FileField(
                        blank=True, null=True, upload_to="appraisals/filled/"
                    ),
                ),
                (
                    "reference",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "improvement_actions",
                    models.TextField(
                        blank=True, help_text="Actions the employee will take."
                    ),
                ),
                (
                    "support_required",
                    models.TextField(
                        blank=True, help_text="Support expected from management."
                    ),
                ),
                ...
                (
                    "staff_commitment",
                    models.TextField(
                        blank=True, help_text="Employee's commitment statement."
                    ),
                ),
                (
                    "staff_signature",
                    models.ImageField(
                        blank=True, null=True, upload_to="pip/signatures/"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                (
